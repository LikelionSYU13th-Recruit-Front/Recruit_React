            ...
            <form className="PostMobContainer-Contents" onSubmit={handleSubmit}>
                <div className="PostMobContainer-InfoBox">
                    ...
                    <div className="PostMobContainer-Contents-email">
                        <div className="PostMobContainer-Contents-email-top">
                            <div className="PostMobContainer-Contents-email-subtop">
                ...
                {selectedTrack && (
                    <div className="PostMobContainer-TrackQ">
                        ...
                        <div className="PostMobContainer-TrackQ-Box">
                            <label className="PostMobContainer-TrackQ-question"><span>5.</span><span>역량을 확인할 수 있는 포트폴리오, Github, Notion<br /> 링크가 있다면 첨부해주세요. (선택사항)  </span></label>
