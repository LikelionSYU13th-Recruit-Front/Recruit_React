        ...
        <div className='reviewpage-container'>
            <div className='review-header'>
                ...
                <div className='from-12th'>
                     <div className='from-text'>FROM. 12th</div>
                </div>
            </div>
            <div className='review-body'>
                ...
                <div className='review-design-boxes'>
                    <div className='review-box-1'>
                        ...
                        <div className="review-box-header-left">
                            <img src={PinkLion} className='lion-logo' />
                            <div className='header-title-design'>든든한 인생 서포터</div>
                            </div>
                            <div className='header-name-1'>현O진</div>
                        </div>
                    ...
                    <div className='review-box-2'>
                        ...
                        <div className="review-box-header-left">
                            <img src={PinkLion} className='lion-logo' />
                            <div className='header-title-design'>기획, 디자인에 관심있는 누구나</div>
                            </div>
                            <div className='header-name-2'>김O나</div>
                        </div>
                        <div className='review-content-box'>
                            <div className='review-content'>
                ...
                <div className='review-frontend-boxes'>
                    ...
                    <div className='review-box-2'>
                        ...
                        <div className="review-box-header-left">
                            <img src={BlueLion} className='lion-logo' />
                            <div className='header-title-frontend'>멋사는 하는게 이득!</div>
                            </div>
                            <div className='header-name-4'>장O익</div>
                        </div>
                        <div className='review-content-box'>
                            <div className='review-content'>
                ...
                <div className='review-backend-boxes'>
                    <div className='review-box-1'>
                        ...
                        <div className="review-box-header-left">
                            ...
                            <div className='header-title-backend'>모두가 알았으면 하는 멋사</div>
                            </div>
                            <div className='header-name-5'>권O진</div>
                        </div>
                        <div className='review-content-box'>
                            <div className='review-content'>
                    ...
                    <div className='review-box-2'>
                        <div className='review-box-header'>
                            <div className="review-box-header-left">
                            <img src={YellowLion} className='lion-logo' />
                            <div className='header-title-backend'>개발 자신감을 지탱하는 디딤돌</div>
                            </div>
                            <div className='header-name-6'>김O현</div>
                        </div>
                        <div className='review-content-box'>
                            <div className='review-content'>
