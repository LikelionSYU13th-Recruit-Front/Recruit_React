            ...
            <div className='activity-body'>
                ...
                <div className='activity-body-idea'>
                    <div className='activity-body-desc-2'>
                        ...
                        <h2 className='desc-name'>멋쟁이사자처럼 <span className='blue-color'>아이디어톤에서</span><br /><span>창의력을 펼쳐보세요</span></h2>
                ...
                <div className='activity-body-python'>
                    <div className='activity-body-desc-4'>
                        ...
                        <span className='desc-main'>학교를 넘어 열정적인 멋사인들과 프로젝트를 만들어보세요.<br />
