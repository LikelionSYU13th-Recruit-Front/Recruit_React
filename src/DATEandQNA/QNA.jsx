...
export default function QNApage(){
    ...
    const toggleClickQNA = (index) =>[
        setActiveQNA(activeQNA === index ? null: index)
    ]
        ...
        <div className="QNA-container">
            ...
            <div className="QNA-main-container">
                <ul className="QNA-qna-container">
                    {
                        qnaContents.map((qnaContents,index)=>(
                            <li key={index}>
                                <div className="qna-DropDown">
                                    <div className={`qnaContents-menu ${activeQNA === index ? 'qnaContents-menu-active' : ''}`} >
                                        {qnaContents}
                                        <img 
                                            onClick={() => {toggleClickQNA(index)}} 
                                            src={activeQNA===index ? dropupIcon : dropdownIcon} 
                                            alt={activeQNA===index ? 'up' : 'down'}  
                                        />
                                    </div>
                                        {activeQNA === index && (
